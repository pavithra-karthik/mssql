...
@{
    MediaLocations = @{
        SqlMedia = '\\techbuild\sql source\SQL_Server2019\Media\SQL2019'
        SsmsMedia = '\\techbuild\sql source\SQL_Server2019\Media\SSMS_18_6'
	...
	SqlIso = 'en_sql_server_2019_enterprise_x64_dvd_c7d70add.iso'
	...
	#updated below for Cu11
	# Set as an empty string if no Cumulative Update to be installed
	SqlCurrentCu = 'CU11\sqlserver2019-kb5003249-x64.exe'
	CuVersion = "15.0.4138.2"
